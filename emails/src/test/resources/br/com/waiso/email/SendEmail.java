...
/**
 * SendEmail - an email application that sends individual emails to a list of
 * recipients.
 * 
...
public class SendEmail {
	 ...
	 * 
	 * @param from
	 *            The email address that appears in the from feild
	 * @param smtpServer
	 *            FQDN of SMTP server
	 * @param username
	 ...
	 *             thrown when no email recipient is specified
	 */
	...
	public static void main(String[] args) throws IOException {
		Contact from = new Contact("Filo", "filoecubu@gmail.com");
		Contact to = new Contact("Fabiano", "fabianormatias@gmail.com");
